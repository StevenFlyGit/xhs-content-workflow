...
type Insight = { id: string; title: string; summary: string; sourceIds: string[]; score: number }
type Card = {
  title: string
  eyebrow: string
  body: string
...
const initialInsights: Insight[] = [
  { id: 'insight-1', title: 'Agent 的价值不在“会聊天”', summary: '能否在清晰边界内持续完成任务，才是 Agent 成为可靠产品的关键。', sourceIds: ['P02'], score: 96 },
  { id: 'insight-2', title: '全自动不等于更好的体验', summary: '默认执行、关键节点确认，让完成率与用户信任同时提升。', sourceIds: ['P03'], score: 92 },
  { id: 'insight-3', title: '设计人机协作的颗粒度', summary: '自主性不是越多越好，解释、确认与风险边界同样重要。', sourceIds: ['P04'], score: 95 },
  { id: 'insight-4', title: '用三个问题检查 Agent 产品', summary: '任务边界、失败恢复、过程可见性，决定 Agent 能否从玩具走向工具。', sourceIds: ['P05'], score: 89 },
]
  ...
  return (
    <div className="app-shell">
      ...
      <main className="workspace">
        ...
        {step === 'export' && <ExportView project={project} theme={theme} cards={cards} summaryCount={summaryCount} exports={exports} onExport={exportPackage} onRedownload={redownload} exporting={exporting}/>} 
      </main>
